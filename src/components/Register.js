...
const Register = () => {
  ...
  const register = async (formData) => {
    //To prevent making an API call after validating the input if it failed
    ...
    >
      ...
      <Box className="content">
        <Stack spacing={2} className="form">
          ...
          {loading ? <Box display="flex" justifyContent="center" alignItems="center" minHeight={40}>
             <CircularProgress size={24} />  </Box> :  <Button className="button" variant="contained" onClick={() => {register(formData)}} disabled={loading}> 
                      Register Now </Button> 
           }
